...
- [Awesome-gait-recognition  ](#awesome-gait-recognition--)
  - [Table of Contents (Ongoing updates)](#table-of-contents-ongoing-updates)
  - [1. Survey](#1-survey)
  - [2. arXiv](#2-arxiv)
  - [3. Conference](#3-conference)
    ...
    - [5. ECCV](#5-eccv)
    - [6. ICME](#6-icme)
    - [7. Other Top Conferences](#7-other-top-conferences)
  - [4. Journal](#4-journal)
    - [1. TPAMI](#1-tpami)
    - [2. TIP](#2-tip)
    - [3. TIFS](#3-tifs)
    ...
    - [6. TCSVT](#6-tcsvt)
    - [7. TBIOM](#7-tbiom)
    - [8. Other Top Journals](#8-other-top-journals)
...
- A survey on gait recognition via wearable sensors. \[[CSUR-19](https://dl.acm.org/doi/abs/10.1145/3340293)\]
...
- Learning Visual Prompt for Gait Recognition.\[[CVPR-24](https://openaccess.thecvf.com/content/CVPR2024/papers/Ma_Learning_Visual_Prompt_for_Gait_Recognition_CVPR_2024_paper.pdf)\]  ![Static Badge](https://img.shields.io/badge/appearance%20based-67AB9F)
...
- GaitGCI: Generative Counterfactual Intervention for Gait Recognition.\[[CVPR-23](https://openaccess.thecvf.com/content/CVPR2023/papers/Li_An_In-Depth_Exploration_of_Person_Re-Identification_and_Gait_Recognition_in_CVPR_2023_paper.pdf)\] ![Static Badge](https://img.shields.io/badge/appearance%20based-67AB9F)
...
- Lagrange Motion Analysis and View Embeddings for Improved Gait Recognition.\[[CVPR-22](https://openaccess.thecvf.com/content/CVPR2022/papers/Chai_Lagrange_Motion_Analysis_and_View_Embeddings_for_Improved_Gait_Recognition_CVPR_2022_paper.pdf)\] ![Static Badge](https://img.shields.io/badge/model%20based-EA6B66)
- Cloth-Changing Person Re-Identification From a Single Image With Gait Prediction and Regularization. \[[CVPR-22](https://openaccess.thecvf.com/content/CVPR2022/papers/Jin_Cloth-Changing_Person_Re-Identification_From_a_Single_Image_With_Gait_Prediction_CVPR_2022_paper.pdf)\]![Static Badge](https://img.shields.io/badge/appearance%20based-67AB9F)
- Towards a Deeper Understanding of Skeleton-based Gait Recognition. \[[CVPRW-22](https://openaccess.thecvf.com/content/CVPR2022W/Biometrics/html/Teepe_Towards_a_Deeper_Understanding_of_Skeleton-Based_Gait_Recognition_CVPRW_2022_paper.html)\] ![Static Badge](https://img.shields.io/badge/model%20based-EA6B66)

- Cross-View Gait Recognition With Deep Universal Linear Embeddings. \[[CVPR-21](https://openaccess.thecvf.com/content/CVPR2021/papers/Zhang_Cross-View_Gait_Recognition_With_Deep_Universal_Linear_Embeddings_CVPR_2021_paper.pdf)\]![Static Badge](https://img.shields.io/badge/appearance%20based-67AB9F)
- Gait Recognition via Semi-supervised Disentangled Representation Learning to Identity and Covariate Features. \[[CVPR-20](https://openaccess.thecvf.com/content_CVPR_2020/papers/Li_Gait_Recognition_via_Semi-supervised_Disentangled_Representation_Learning_to_Identity_and_CVPR_2020_paper.pdf)\]![Static Badge](https://img.shields.io/badge/model%20based-EA6B66)
- GaitPart: Temporal Part-Based Model for Gait Recognition. \[[CVPR-20](https://openaccess.thecvf.com/content_CVPR_2020/papers/Fan_GaitPart_Temporal_Part-Based_Model_for_Gait_Recognition_CVPR_2020_paper.pdf)\]![Static Badge](https://img.shields.io/badge/appearance%20based-67AB9F)
- A geometric convnet on 3d shape manifold for gait recognition. \[[CVPRW-20](http://openaccess.thecvf.com/content_CVPRW_2020/html/w50/Hosni_A_Geometric_ConvNet_on_3D_Shape_Manifold_for_Gait_Recognition_CVPRW_2020_paper.html)\]![Static Badge](https://img.shields.io/badge/model%20based-EA6B66)
- Learning Joint Gait Representation via Quintuplet Loss Minimization. \[[CVPR-19](https://openaccess.thecvf.com/content_CVPR_2019/papers/Zhang_Learning_Joint_Gait_Representation_via_Quintuplet_Loss_Minimization_CVPR_2019_paper.pdf)\]![Static Badge](https://img.shields.io/badge/model%20based-EA6B66)
- Gait Recognition via Disentangled Representation Learning. \[[CVPR-19](https://openaccess.thecvf.com/content_CVPR_2019/papers/Zhang_Gait_Recognition_via_Disentangled_Representation_Learning_CVPR_2019_paper.pdf)\]![Static Badge](https://img.shields.io/badge/model%20based-EA6B66)
- EV-Gait: Event-Based Robust Gait Recognition Using Dynamic Vision Sensors. \[[CVPR-19](https://openaccess.thecvf.com/content_CVPR_2019/papers/Wang_EV-Gait_Event-Based_Robust_Gait_Recognition_Using_Dynamic_Vision_Sensors_CVPR_2019_paper.pdf)\]![Static Badge](https://img.shields.io/badge/appearance%20based-67AB9F)
- Joint Intensity and Spatial Metric Learning for Robust Gait Recognition. \[[CVPR-17](https://openaccess.thecvf.com/content_cvpr_2017/papers/Makihara_Joint_Intensity_and_CVPR_2017_paper.pdf)\]![Static Badge](https://img.shields.io/badge/appearance%20based-67AB9F)
- GaitGAN: Invariant Gait Feature Extraction Using Generative Adversarial Networks. \[[CVPRW-17](https://openaccess.thecvf.com/content_cvpr_2017_workshops/w6/papers/Yu_GaitGAN_Invariant_Gait_CVPR_2017_paper.pdf)\]![Static Badge](https://img.shields.io/badge/appearance%20based-67AB9F)
- Gait Recognition under Speed Transition. \[[CVPR-14](https://openaccess.thecvf.com/content_cvpr_2014/papers/Mansur_Gait_Recognition_under_2014_CVPR_paper.pdf)\]![Static Badge](https://img.shields.io/badge/appearance%20based-67AB9F)
- Video from nearly still: An application to low frame-rate gait recognition. \[[CVPR-12](https://ieeexplore.ieee.org/document/6247844)\]![Static Badge](https://img.shields.io/badge/appearance%20based-67AB9F)
- Gait recognition from time-normalized joint-angle trajectories in the walking plane.\[[CVPR-01](https://ieeexplore.ieee.org/abstract/document/991036/)\]![Static Badge](https://img.shields.io/badge/model%20based-EA6B66)
